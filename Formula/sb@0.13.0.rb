...
class SbAT0130 < Formula
  ...
  on_macos do
    ...
    if Hardware::CPU.intel?
      url "#{STORE_API_URL}/bundler-cli-repository/homebrew/HOMEBREW_SYNKBRIDGE_STORE_KEY/sb/0.13.0/amd64", using: BundlerCLIDownloadStrategy
      sha256 "2154225e720a36f89d953a0675ae5fbfa40eb214980c35612324b0cb27e6d35d"
    elsif Hardware::CPU.arm?
      url "#{STORE_API_URL}/bundler-cli-repository/homebrew/HOMEBREW_SYNKBRIDGE_STORE_KEY/sb/0.13.0/arm64", using: BundlerCLIDownloadStrategy
