...
class SbAT0914 < Formula
  ...
  on_macos do
    ...
    if Hardware::CPU.intel?
      url "#{STORE_API_URL}/bundler-cli-repository/homebrew/HOMEBREW_SYNKBRIDGE_STORE_KEY/sb/0.9.14/amd64", using: BundlerCLIDownloadStrategy
      sha256 "314dc60f0bc2e8d5298dcffd856e4fc3fb9e567076fb350d762c071a143dbc14"
    elsif Hardware::CPU.arm?
      url "#{STORE_API_URL}/bundler-cli-repository/homebrew/HOMEBREW_SYNKBRIDGE_STORE_KEY/sb/0.9.14/arm64", using: BundlerCLIDownloadStrategy
