...
class SbAT0152 < Formula
  ...
  on_macos do
    ...
    if Hardware::CPU.intel?
      url "#{STORE_API_URL}/bundler-cli-repository/homebrew/HOMEBREW_SYNKBRIDGE_STORE_KEY/sb/0.15.2/amd64", using: BundlerCLIDownloadStrategy
      sha256 "448fd632d64e4098c46090c860b4900ee9cb87f3719d6fbd23e3b4c46a3f1827"
    elsif Hardware::CPU.arm?
      url "#{STORE_API_URL}/bundler-cli-repository/homebrew/HOMEBREW_SYNKBRIDGE_STORE_KEY/sb/0.15.2/arm64", using: BundlerCLIDownloadStrategy
