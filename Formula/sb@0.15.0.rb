...
class SbAT0150 < Formula
  ...
  on_macos do
    ...
    if Hardware::CPU.intel?
      url "#{STORE_API_URL}/bundler-cli-repository/homebrew/HOMEBREW_SYNKBRIDGE_STORE_KEY/sb/0.15.0/amd64", using: BundlerCLIDownloadStrategy
      sha256 "346337c80335160d587abc9c34b008a034a9a621990211f2991943302f989788"
    elsif Hardware::CPU.arm?
      url "#{STORE_API_URL}/bundler-cli-repository/homebrew/HOMEBREW_SYNKBRIDGE_STORE_KEY/sb/0.15.0/arm64", using: BundlerCLIDownloadStrategy
