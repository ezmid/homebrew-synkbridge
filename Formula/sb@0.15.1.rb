...
class SbAT0151 < Formula
  ...
  on_macos do
    ...
    if Hardware::CPU.intel?
      url "#{STORE_API_URL}/bundler-cli-repository/homebrew/HOMEBREW_SYNKBRIDGE_STORE_KEY/sb/0.15.1/amd64", using: BundlerCLIDownloadStrategy
      sha256 "ec3a746b65269155481f2b8afa01e55b1322c101eac35792a27e82fedf416f6e"
    elsif Hardware::CPU.arm?
      url "#{STORE_API_URL}/bundler-cli-repository/homebrew/HOMEBREW_SYNKBRIDGE_STORE_KEY/sb/0.15.1/arm64", using: BundlerCLIDownloadStrategy
