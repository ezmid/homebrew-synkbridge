...
class SbAT0110 < Formula
  ...
  on_macos do
    ...
    if Hardware::CPU.intel?
      url "#{STORE_API_URL}/bundler-cli-repository/homebrew/HOMEBREW_SYNKBRIDGE_STORE_KEY/sb/0.11.0/amd64", using: BundlerCLIDownloadStrategy
      sha256 "81f23fa58083870337fd036d72be5462235b127e4776aa6263a169054c75c25f"
    elsif Hardware::CPU.arm?
      url "#{STORE_API_URL}/bundler-cli-repository/homebrew/HOMEBREW_SYNKBRIDGE_STORE_KEY/sb/0.11.0/arm64", using: BundlerCLIDownloadStrategy
