...
class SbAT099 < Formula
  ...
  on_macos do
    ...
    if Hardware::CPU.intel?
      url "#{STORE_API_URL}/bundler-cli-repository/homebrew/HOMEBREW_SYNKBRIDGE_STORE_KEY/sb/0.9.9/amd64", using: BundlerCLIDownloadStrategy
      sha256 "c11fbcd996d09704539193e6caa1bbec1c0c59486d436bb1e6700f2ddf97fbcd"
    elsif Hardware::CPU.arm?
      url "#{STORE_API_URL}/bundler-cli-repository/homebrew/HOMEBREW_SYNKBRIDGE_STORE_KEY/sb/0.9.9/arm64", using: BundlerCLIDownloadStrategy
