...
class SbAT0916 < Formula
  ...
  on_macos do
    ...
    if Hardware::CPU.intel?
      url "#{STORE_API_URL}/bundler-cli-repository/homebrew/HOMEBREW_SYNKBRIDGE_STORE_KEY/sb/0.9.16/amd64", using: BundlerCLIDownloadStrategy
      sha256 "b58d63bc83afec81b0c5965823621b018c8de8dc65ae2ffe2d5b51d3a273fefb"
    elsif Hardware::CPU.arm?
      url "#{STORE_API_URL}/bundler-cli-repository/homebrew/HOMEBREW_SYNKBRIDGE_STORE_KEY/sb/0.9.16/arm64", using: BundlerCLIDownloadStrategy
