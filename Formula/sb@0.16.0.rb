...
class SbAT0160 < Formula
  ...
  on_macos do
    ...
    if Hardware::CPU.intel?
      url "#{STORE_API_URL}/bundler-cli-repository/homebrew/HOMEBREW_SYNKBRIDGE_STORE_KEY/sb/0.16.0/amd64", using: BundlerCLIDownloadStrategy
      sha256 "0f63af0c83f5dd4680ddfe7246aa0f56a96871b6282446a9d0c63ca4172f627d"
    elsif Hardware::CPU.arm?
      url "#{STORE_API_URL}/bundler-cli-repository/homebrew/HOMEBREW_SYNKBRIDGE_STORE_KEY/sb/0.16.0/arm64", using: BundlerCLIDownloadStrategy
