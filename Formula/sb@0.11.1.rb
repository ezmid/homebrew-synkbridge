...
class SbAT0111 < Formula
  ...
  on_macos do
    ...
    if Hardware::CPU.intel?
      url "#{STORE_API_URL}/bundler-cli-repository/homebrew/HOMEBREW_SYNKBRIDGE_STORE_KEY/sb/0.11.1/amd64", using: BundlerCLIDownloadStrategy
      sha256 "eab5c48ed02e9981bbf9d6217d4efce0ecda7ecc5b36ff81566de343a734049f"
    elsif Hardware::CPU.arm?
      url "#{STORE_API_URL}/bundler-cli-repository/homebrew/HOMEBREW_SYNKBRIDGE_STORE_KEY/sb/0.11.1/arm64", using: BundlerCLIDownloadStrategy
