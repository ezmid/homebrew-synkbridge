...
class SbAT0103 < Formula
  ...
  on_macos do
    ...
    if Hardware::CPU.intel?
      url "#{STORE_API_URL}/bundler-cli-repository/homebrew/HOMEBREW_SYNKBRIDGE_STORE_KEY/sb/0.10.3/amd64", using: BundlerCLIDownloadStrategy
      sha256 "6ef069e1ddc8d020e58c4c3bd07455152f1928638c2878718ee5e28f6402915b"
    elsif Hardware::CPU.arm?
      url "#{STORE_API_URL}/bundler-cli-repository/homebrew/HOMEBREW_SYNKBRIDGE_STORE_KEY/sb/0.10.3/arm64", using: BundlerCLIDownloadStrategy
