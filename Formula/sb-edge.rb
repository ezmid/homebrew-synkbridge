...
class SbEdge < Formula
  ...
  on_macos do
    ...
    if Hardware::CPU.intel?
      url "#{STORE_API_URL}/bundler-cli-repository/homebrew/#{ENV['HOMEBREW_SYNKBRIDGE_STORE_KEY']}/sb-edge/546/amd64", using: BundlerCLIDownloadStrategy
      sha256 ""
    elsif Hardware::CPU.arm?
      url "#{STORE_API_URL}/bundler-cli-repository/homebrew/#{ENV['HOMEBREW_SYNKBRIDGE_STORE_KEY']}/sb-edge/546/arm64", using: BundlerCLIDownloadStrategy
      sha256 ""
    end
  end
